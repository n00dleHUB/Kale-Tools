...
- **Chroma** — Apply material color, patterns or even a custom texture. Restores materials on Godot reboot. Basically just an alternative to Matavatar's Recolorizer plugin. Built from scratch. Added some stuff I really wanted.
