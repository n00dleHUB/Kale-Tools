...
If you don't want the full suite, simply pick and choose from any of the **Kale_** tools — drag their individual folder into `godotproject/addons/`. You don't need Kale_Tools.
