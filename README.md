...
- **Chroma** — Apply material color, patterns or even a custom texture. Restores materials on Godot reboot. Basically just an alternative to Matavatar's Recolorizer plugin. Built from scratch and added some stuff I really wanted from it and overhauled it abit. Functions the same way.
