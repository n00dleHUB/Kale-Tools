...
const PRESETS := {
	...
	"Moody": { "intensity": 0.5, "rotation": 180.0, "ambient": Color(0.3, 0.3, 0.35), "ambient_strength": 0.3,
		"sun": true, "sun_elevation": 20.0, "sun_azimuth": 45.0, "sun_color": Color(0.8, 0.6, 0.4), "sun_energy": 0.4,
	...
	"Warm": { "intensity": 1.2, "rotation": 45.0, "ambient": Color(1.0, 0.88, 0.65), "ambient_strength": 0.7,
		"sun": true, "sun_elevation": 30.0, "sun_azimuth": 45.0, "sun_color": Color(1.0, 0.7, 0.45), "sun_energy": 0.8,
		"hdri": "kloofendal_48d_partly_cloudy_puresky_4k.hdr",
		"sdfgi": false, "ssao": false, "ssil": false, "ssr": false },
	"Cool": { "intensity": 0.8, "rotation": 135.0, "ambient": Color(0.65, 0.75, 1.0), "ambient_strength": 0.5,
		"sun": true, "sun_elevation": 50.0, "sun_azimuth": 45.0, "sun_color": Color(0.7, 0.8, 1.0), "sun_energy": 0.7,
		"hdri": "kloofendal_48d_partly_cloudy_puresky_4k.hdr",
		"sdfgi": false, "ssao": false, "ssil": false, "ssr": false },
	"Night": { "intensity": 0.8, "rotation": 150.0, "ambient": Color(0.65, 0.75, 1.0), "ambient_strength": 0.5,
