...
const PRESETS := {
	...
	"Asphalt": { "color": Color.WHITE, "rough": 0.9, "spec": 0.3, "opacity": 1.0, "tiling": 3.0, "texture": "asphalt.png" },
	"Bricks": { "color": Color.WHITE, "rough": 0.8, "spec": 0.3, "opacity": 1.0, "tiling": 2.0, "texture": "bricks.png" },
	"Concrete": { "color": Color.WHITE, "rough": 0.9, "spec": 0.3, "opacity": 1.0, "tiling": 2.0, "texture": "concrete.png" },
	"Dirt": { "color": Color.WHITE, "rough": 1.0, "spec": 0.1, "opacity": 1.0, "tiling": 2.0, "texture": "dirt.png" },
	"Glass": { "color": Color(0.78, 0.85, 0.98), "rough": 0.05, "spec": 1.0, "opacity": 0.2, "tiling": 1.0, "texture": "" },
	"Gravel": { "color": Color.WHITE, "rough": 1.0, "spec": 0.2, "opacity": 1.0, "tiling": 4.0, "texture": "gravel.png" },
	"Metal": { "color": Color(0, 0, 0), "rough": 0.25, "spec": 1.0, "opacity": 1.0, "tiling": 1.0, "texture": "" },
	"Planks": { "color": Color.WHITE, "rough": 0.7, "spec": 0.4, "opacity": 1.0, "tiling": 2.0, "texture": "planks.png" },
	"Rock": { "color": Color.WHITE, "rough": 0.9, "spec": 0.2, "opacity": 1.0, "tiling": 2.0, "texture": "rock.png" },
	"Rocks River": { "color": Color.WHITE, "rough": 0.9, "spec": 0.2, "opacity": 1.0, "tiling": 3.0, "texture": "rocks_river.png" },
	"Rocky Terrain": { "color": Color.WHITE, "rough": 1.0, "spec": 0.2, "opacity": 1.0, "tiling": 3.0, "texture": "rocky_terrain.png" },
	"Sand": { "color": Color.WHITE, "rough": 1.0, "spec": 0.1, "opacity": 1.0, "tiling": 3.0, "texture": "sand.png" },
	"Tiles Checker": { "color": Color.WHITE, "rough": 0.6, "spec": 0.5, "opacity": 1.0, "tiling": 2.0, "texture": "tiles_checker.png" },
	"Tiles Marble": { "color": Color.WHITE, "rough": 0.3, "spec": 0.7, "opacity": 1.0, "tiling": 2.0, "texture": "tiles_marble.png" },
	"Tiles Terracotta": { "color": Color.WHITE, "rough": 0.7, "spec": 0.4, "opacity": 1.0, "tiling": 2.0, "texture": "tiles_terracotta.png" },
	...
	"Wood": { "color": Color.WHITE, "rough": 0.7, "spec": 0.3, "opacity": 1.0, "tiling": 4.0, "texture": "wood.png" },
}
...
static func _resolve_texture(custom_texture: String, preset: String, pattern: String) -> Texture2D:
	...
	var filename: String = pdata.get("texture", "")
	var tex_path := ""
	if not filename.is_empty():
		tex_path = plugin_root + "/textures/" + filename
