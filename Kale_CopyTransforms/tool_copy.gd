...
func build_panel() -> Control:
	...
	src_path.placeholder_text = "Select a node in viewport or scene tree"
	src_path.text = ""
	...
	tgt_path.placeholder_text = "Select a node in viewport or scene tree"
	tgt_path.text = ""
...
func _on_copy_pressed() -> void:
	...
	Copier.copy_all(source, target, pos, rot, scl)
